...
/// and allows to write generic function accepting both Rust primitive integer types and IR
/// integers.
...
///
/// This is meant to be used as a trait bound in various functions accepting literals as arguments,
/// and allows to write generic function accepting both Rust primitive floating-point types and IR
/// floats.
