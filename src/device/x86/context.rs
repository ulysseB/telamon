...
impl Context {
    ...
    fn allocate_array(&self, size: usize) -> CpuArray { CpuArray::new(size) }
...
/// Given a function string and its arguments as ThunkArg, compile to a binary,
/// executes it and returns the time elapsed. Converts ThunkArgs to HoldTHunk
/// as we want to allocate memory for temporary arrays at the last possible
/// moment
