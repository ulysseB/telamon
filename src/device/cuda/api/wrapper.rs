...
extern {
    ...
    pub fn get_function(context: *const CudaContext,
                        module: *const CudaModule,
                        name: *const libc::c_char) -> *mut CudaFunction;
    pub fn launch_kernel(context: *const CudaContext,
    ...
    pub fn copy_DtoH(context: *const CudaContext,
                     src: *const CudaArray,
                     dst: *mut libc::c_void,
                     size: u64);
    pub fn copy_HtoD(context: *const CudaContext,
                     src: *const libc::c_void,
                     dst: *const CudaArray,
                     size: u64);
    pub fn copy_DtoD(context: *const CudaContext,
                     src: *const CudaArray,
                     dst: *mut CudaArray,
                     size: u64);
    pub fn randomize_float_array(ctx: *const CudaContext, dst: *mut CudaArray, size: u64,
                                 mean: f32, stddev: f32);
    pub fn device_attribute(context: *const CudaContext, attr: u32) -> i32;
    pub fn create_cuptiEventGroupSets(context: *const CudaContext,
                                      num_event: u32,
                                      event_names: *const *const libc::c_char,
                                      event_ids: *mut u32) -> *mut CuptiEventGroupSets;
    pub fn free_cuptiEventGroupSets(context: *const CudaContext,
