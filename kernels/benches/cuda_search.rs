...
fn main() {
    ...
    for _ in 0..4 {
        // 1.5
        benchmark::<linalg::Axpy<f32>, _>((1 << 26, true), &executor, |params, ctx| {
          saxpy_reference(&cublas_handle, params, ctx)
          });
        // 2.82 without tb
        let params = linalg::MatMulP::new(256, 256, 32); //.transpose_b();
        ...
        // 0.87 in 2.38 hours/4H, 0.77 with free tiling
