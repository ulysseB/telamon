...
impl<'a> PartialIterator<'a> {
    /// Generates the list of sets of new objects and sets of objects to
    /// iterate on to visit all the new combinations of elements in the
    /// given combination of sets.
    pub fn generate(
