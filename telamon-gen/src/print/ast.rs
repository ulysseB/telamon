...
impl<'a> Variable<'a> {
    ...
    pub fn with_set(set: &ir::Set) -> Self {
        Self::with_prefix(set.def().prefix())
    }
...
impl<'a> Context<'a> {
    ...
    pub fn input(&self, id: usize) -> &print::ValueIdent {
        &self.inputs[id]
    }
}
