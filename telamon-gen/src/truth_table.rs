...
struct TableView<'a> {
    ...
    /// Maps the id of a view dimension to the id of dimension of the original
    /// table.
    dim_map: Vec<usize>,
...
where 'a: 'b
{
    ...
    fn into_iter(self) -> Self::IntoIter { (&self.view).into_iter() }
}
...
where 'a: 'b
{
    ...
    fn into_iter(self) -> Self::IntoIter { (&mut self.view).into_iter() }
}
