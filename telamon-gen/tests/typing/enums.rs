...
fn enum_redefinition() {
    assert_eq!(
        ...
        Some(Spanned {
            ...
            data: TypeError::Redefinition(String::from("foo"), Hint::Enum),
        })
    );
    assert!(
        parser::parse_ast(Lexer::from(
...
fn enum_field_redefinition() {
    assert_eq!(
        ...
        Some(Spanned {
            ...
            data: TypeError::Redefinition(String::from("AB"), Hint::EnumAttribute,),
        })
    );
    assert!(
        parser::parse_ast(Lexer::from(
    ...
    assert_eq!(
        ...
        Some(Spanned {
            ...
            data: TypeError::Redefinition(String::from("Symmetric"), Hint::EnumAttribute),
        })
    );
    assert!(
        parser::parse_ast(Lexer::from(
    ...
    assert_eq!(
        ...
        Some(Spanned {
            ...
            data: TypeError::Redefinition(String::from("A"), Hint::EnumAttribute),
        })
    );
    assert!(
        parser::parse_ast(Lexer::from(
...
fn enum_symmetric_two_parametric() {
    ...
    assert_eq!(
        ...
        Some(Spanned {
            ...
            data: TypeError::BadSymmetricArg(vec![VarDef {
